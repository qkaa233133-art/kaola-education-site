...
var client_references_default = {
	...
	"575ccc7b0ac9": async () => {
		const m = await import("./assets/LaserFlowLayer-fySWq_rJ.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"77e77ac8432d": async () => {
		const m = await import("./assets/GooeyClickEffects-C7t3lMfw.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"89049869c793": async () => {
		const m = await import("./assets/TeacherHero-26IcPlIl.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"8f7ba5393f33": async () => {
		const m = await import("./assets/error-boundary-BC3SALsf.js");
		return {
			get "ErrorBoundary"() {
	...
	"a3761f8478a2": async () => {
		const m = await import("./assets/ScrollExperience-BFJOY6Xm.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e057204773f7": async () => {
		const m = await import("./assets/Galaxy-BSbM4DJL.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e0a5b7545e29": async () => {
		const m = await import("./assets/CopyWechat-DHJYFGzL.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e2eb0723d79d": async () => {
		const m = await import("./assets/AssessmentQuiz-CHQaZ5lD.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ee6cb3d92c61": async () => {
		const m = await import("./assets/layout-segment-context-BcPbGuCE.js");
